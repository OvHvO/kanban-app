          ...
          <div className="flex items-center gap-3">
            ...
            {activeGithubUrl ? (
              <div className="flex items-center gap-2">
                <a href={activeGithubUrl} target="_blank" rel="noreferrer" className="text-slate-600 hover:text-indigo-600 transition-all bg-white rounded-full p-1 border-2 border-sketchy hover:translate-y-px shadow-sm hover:shadow-[2px_2px_0_#cbd5e1] hover:bg-slate-50" title="View GitHub Repository">
